...
class PyArrow(PythonPackage):
    ...
    depends_on("py-types-python-dateutil@2.8.10:", type=("build", "run"), when="@1.3:1.3")
    depends_on("py-backports-zoneinfo", type=("build", "run"), when="@1.4: ^python@:3.8")
    depends_on("py-tzdata", type=("build", "run"), when="@1.4:")
